 ...
 * 
 */
@XmlRootElement(name = "MovieNotFoundException", namespace = "http://movies.ws.adoo.udc.es/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "MovieNotFoundException", namespace = "http://movies.ws.adoo.udc.es/", propOrder = {
    "faultInfo",
    "message",
    "suppressed"
})
public class MovieNotFoundExceptionBean {
     ...
     * 
     * @return
     *     returns MovieNotFoundExceptionInfo
     */
     ...
     */
    public void setFaultInfo(MovieNotFoundExceptionInfo faultInfo) {
