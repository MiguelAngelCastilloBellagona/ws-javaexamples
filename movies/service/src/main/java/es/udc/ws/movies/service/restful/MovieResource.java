...
public class MovieResource extends Application {
    ...
    public ServiceResponse findMovies(@QueryParam("year")  String year,
        ...
        try {
            ...
            return new ServiceResponse(MovieXMLConversor
                    .toXML(movieInformationList));
        } catch (Exception e) {
            ...
            throw new WebApplicationException(
                    ...
                    entity(response).type("application/xml").build());            
    ...
    public Response addMovie(MovieInformationTO movieInformation,
        ...
        return Response.created(URI.create(ui.getRequestUri().toString() + 
