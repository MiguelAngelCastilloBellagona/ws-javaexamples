...
public class ObjectFactory {
    ...
    private final static QName _IncorrectTickerSymbolException_QNAME = new QName("http://ws.adoo.udc.es/", "IncorrectTickerSymbolException");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.adoo.udc.es/", name = "IncorrectTickerSymbolException")
